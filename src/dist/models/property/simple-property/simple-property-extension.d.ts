 ...
 */
export declare const SimplePropertyExtension: {
    PropertySingleValue: typeof PropertySingleValue;
    PropertyEnumeratedValue: typeof PropertyEnumeratedValue;
};
/**
 * List of all defined extensions of SimpleProperty - for parsing and type casting
 */
export declare type SimplePropertyExtensionType = keyof typeof SimplePropertyExtension;
/**
 * map anonymous SimpleProperties from database to actual classes
 * @param  {ISimpleProperty} someSimpleProperty
 * @return {SimpleProperty}
*/
export declare const someSimplePropertyFromData: (someSimpleProperty: ISimpleProperty) => SimpleProperty;
