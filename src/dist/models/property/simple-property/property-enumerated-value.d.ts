 ...
 */
export declare class PropertyEnumeratedValue extends SimpleProperty implements IPropertyEnumeratedValue {
    /**
    ...
    */
    ...
    enumerationReference: PropertyEnumerationReference;
    /**
    ...
    */
    constructor(name: Identifier, description?: Text, enumerationReference?: PropertyEnumerationReference, partOfPset?: PropertySetReference[], partOfComplex?: PropertyReference[]);
