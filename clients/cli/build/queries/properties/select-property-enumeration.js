...
import { PropertyEnumerationRepository, } from '@building-properties-manager/core';
import { Logger } from '../../helpers/prompt-helpers.js';
const { Select } = E;
export const selectPropertyEnumerationPrompt = async (old = null) => {
    ...
    if (enumerations.length >= 1) {
        const prompt = new Select({
            ...
            choices: enumerations.map((e) => ({
                ...
                value: e.name.value,
                hint: `Unit: ${JSON.stringify(e.unit)}, with value types: ${e.enumerationValues
                    .map((eV) => eV.type)
...
//# sourceMappingURL=select-property-enumeration.js.map